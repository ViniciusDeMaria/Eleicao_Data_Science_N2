# -*- coding: utf-8 -*-
"""Exercicio_Eleição_2024.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KEaVSPrCxd7napNscUunbL5YeuOACTGx

# Exercício Eleições 2024

Alunos: Vinicius Henrique Bonazzoli Fogaça de Maria.

Você irá acessar o site do TSE e irá baixar os dados das eleições municipais 2024 e fará
uma análise de dados usando técnicas de Data Science para apresentar as
informações detalhadas.

Você deverá extrair informações interessantes e úteis dos conjuntos de dados
presentes neste site, como por exemplo:
...
#Aqui defino a pasta de output para retornar os csv e png geradas pelos graficos.
output_path = '/content/sample_data/output'

#Aqui defino os caminhos dos documentos.
data_paths = {
  "candidatos": "/content/sample_data/info_docs/candidatos/",
  "candidatos_bens": "/content/sample_data/info_docs/candidatos_bens/",
  "candidatos_info_complementar": "/content/sample_data/info_docs/candidatos_info_complementar/",
  "candidatos_redes_sociais": "/content/sample_data/info_docs/candidatos_redes_sociais/",
  "coligacoes": "/content/sample_data/info_docs/coligacoes/",
  "motivo_cassacao": "/content/sample_data/info_docs/motivo_cassacao/",
  "vagas": "/content/sample_data/info_docs/consulta_vagas/"
}
...
try:
  ...
  top_5_bens = total_bens_por_candidato.nlargest(5, 'VR_BEM_CANDIDATO')
  top_5_bens = top_5_bens.merge(prefeitos_eleitos, on='SQ_CANDIDATO')
  top_5_bens.to_csv(output_path + "/total_bens_prefeitos_eleitos.csv", index=False)
  ...
  plt.title("Top 5 Prefeitos Eleitos com Maior Total de Bens Declarados")
  plt.xlabel("Nome do Candidato")
  plt.ylabel("Total de Bens Declarados")
  plt.xticks(rotation=35)
  plt.tight_layout()

  plt.savefig(output_path + "/total_bens_prefeitos_eleitos.png")
  plt.show()
  plt.close()
except Exception as e:
...
try:
  ...
  coligacoes_detalhadas.to_csv(output_path + "/coligacoes_detalhadas.csv", index=False)
  ...
  plt.savefig(output_path + "/coligacoes_eleitos.png")
  plt.show()
except Exception as e:
    print(f"Erro no insight 2 - coligacoes_disputas_vitoria: {e}")

"""Qual partido que tem a maior quantidade de candidatos por UF?"""
...
try:
  ...
  maior_partido_por_uf.to_csv(output_path + "/maior_partido_por_uf.csv", index=False)
  ...
  plt.savefig(output_path + "/partido_maior_por_uf.png")
  plt.show()
  plt.close()
except Exception as e:
...
try:
  ...
  candidatos_por_regiao.to_csv(output_path + "/distribuicao_partido_regiao.csv", index=False)

  plt.figure(figsize=(12, 6))
  sns.barplot(data=candidatos_por_regiao, x='REGIAO', y='NUM_CANDIDATOS', hue='SG_PARTIDO', palette="flare")
  ...
  plt.savefig(output_path + "/distribuicao_partido_regiao.png")
  plt.show()
  plt.close()
except Exception as e:
...
try:
  ...
  partido_dominante_uf.to_csv(output_path + "/partido_dominante_uf.csv", index=False)

  plt.figure(figsize=(10, 8))
  sns.barplot(data=partido_dominante_uf, y='SG_UF', x='TOTAL_CANDIDATOS', hue='SG_PARTIDO', dodge=False,palette="flare")
  plt.title("Partido Dominante por UF (Prefeito, Vice e Vereadores)")
  plt.xlabel("Total de Candidatos")
  plt.ylabel("UF")
  plt.legend(title="Partido")
  plt.savefig(output_path + "/partido_dominante_por_uf.png")
  plt.show()
  plt.close()
except Exception as e:
...
try:
  ...
  cand_indi = dados_info_complementar[dados_info_complementar['CD_ETNIA_INDIGENA'] != 0]
  cand_quilo = dados_info_complementar[dados_info_complementar['ST_QUILOMBOLA'] == 'S']

  candidatos_indigenas = cand_indi.merge(dados_candidatos, on='SQ_CANDIDATO', how='left')
  candidatos_quilombolas = cand_quilo.merge(dados_candidatos, on='SQ_CANDIDATO', how='left')
  ...
  indigenas_por_regiao.to_csv(output_path + "/indigenas_por_regiao.csv", index=False)
  quilombolas_por_regiao.to_csv(output_path + "/quilombolas_por_regiao.csv", index=False)

  fig, ax = plt.subplots(1, 2, figsize=(14, 6))
  sns.barplot(data=indigenas_por_regiao, x='REGIAO', y='NUM_INDIGENAS', ax=ax[0], palette="flare")
  ax[0].set_title("Número de Candidatos Indígenas por Região")

  sns.barplot(data=quilombolas_por_regiao, x='REGIAO', y='NUM_QUILOMBOLAS', ax=ax[1], palette="Blues")
  ax[1].set_title("Número de Candidatos Quilombolas por Região")

  plt.tight_layout()
  plt.savefig(output_path + "/indigenas_quilombolas_regiao.png")
  plt.show()
  plt.close()
except Exception as e:
...
try:
  ...
  redes_por_partido_uf.to_csv(output_path + "/redes_por_partido_uf.csv", index=False)
  ...
  plt.savefig(output_path + "/rede_social_uf.png")
  plt.show();
  plt.close()
except Exception as e:
...
path_propostas='/content/sample_data/SC/'
stop_words = dados_candidatos
...
try:
  ...
  pd.DataFrame(termos_frequentes, columns=['Termo', 'Frequência']).to_csv(output_path + "/termos_propostas.csv", index=False)
  ...
  plt.savefig(output_path + "/nuvem_termos_propostas.png")
  plt.show()
  plt.close()
except Exception as e:
...
a. https://www.ibge.gov.br/geociencias/organizacao-do-territorio/malhas-territoriais/15774-malhas.html
...
dados_municipios = municipios_coordenadas
...
try:
  ...
  candidatos_eleitos.loc[:, 'NM_UE'] = candidatos_eleitos['NM_UE'].str.upper()
  candidatos_eleitos.loc[:, 'SG_UF'] = candidatos_eleitos['SG_UF'].str.upper()
  dados_municipios.loc[:, 'MUNICIPIO'] = dados_municipios['MUNICIPIO'].str.upper()
  dados_municipios.loc[:, 'SG_UF'] = dados_municipios['SG_UF'].str.upper()
  ...
  mapa_brasil.save(output_path + "/resultado_eleicoes_mapa.html")
  print(f"Mapa gerado e salvo como {output_path}'/resultado_eleicoes_mapa.html'")
except Exception as e:
